...
- Name: 07-notebook-ai.spec.mjs >> NOTEBOOK — AI Features (Detailed) >> WEB-NB-AI-002: AI Sidebar — Chat with AI
- Location: tests\e2e\07-notebook-ai.spec.mjs:25:3
...
Call log:
  - waiting for locator('button[title*="AI"], button[aria-label*="AI"]').first()
        ...
        - generic [ref=e239]:
          ...
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 1m ago Open" [ref=e245] [cursor=pointer]:
            ...
            - button "Open" [active] [ref=e255]:
              - text: Open
              - img [ref=e256]
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 4m ago Open" [ref=e258] [cursor=pointer]:
            - generic:
              - img [ref=e260]
              - generic:
                - generic: Playwright Test Notebook
