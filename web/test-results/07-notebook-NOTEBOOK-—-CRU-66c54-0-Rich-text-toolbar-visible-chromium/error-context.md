...
- Name: 07-notebook.spec.mjs >> NOTEBOOK — CRUD & Editor >> WEB-NB-010: Rich text toolbar visible
- Location: tests\e2e\07-notebook.spec.mjs:89:3
    ...
    - generic [ref=e87]:
      ...
      - generic [ref=e224]:
        ...
        - generic [ref=e239]:
          ...
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 1m ago Open" [active] [ref=e245] [cursor=pointer]:
            - generic:
              - img [ref=e247]
              - generic:
          ...
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 8m ago Open" [ref=e258] [cursor=pointer]:
            ...
            - button "Open" [ref=e268]:
              - text: Open
              - img [ref=e269]
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 11m ago Open" [ref=e271] [cursor=pointer]:
            - generic:
              - img [ref=e273]
              - generic:
                - generic: Playwright Test Notebook
...
> 93  |     await page.waitForURL(/\/notebook\//, { timeout: 15_000 });
  ...
  147 |     } else {
  148 |       await snap(page, 'WEB-NB-015_editor-view');
  149 |     }
  150 |   });
  151 | });
  152 | 
