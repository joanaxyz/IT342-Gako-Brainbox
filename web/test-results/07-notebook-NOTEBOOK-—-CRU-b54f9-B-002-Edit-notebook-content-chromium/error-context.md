...
- Name: 07-notebook.spec.mjs >> NOTEBOOK — CRUD & Editor >> WEB-NB-002: Edit notebook content
- Location: tests\e2e\07-notebook.spec.mjs:27:3
        ...
        - generic [ref=e239]:
          ...
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 7m ago Open" [ref=e258] [cursor=pointer]:
            ...
            - button "Open" [ref=e268]:
              - text: Open
              - img [ref=e269]
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 9m ago Open" [ref=e271] [cursor=pointer]:
            - generic:
              - img [ref=e273]
              - generic:
                - generic: Playwright Test Notebook
