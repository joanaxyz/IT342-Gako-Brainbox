...
- Name: 07-notebook-ai.spec.mjs >> NOTEBOOK — AI Features (Detailed) >> WEB-NB-AI-001: AI Sidebar opens with default Chat tool
- Location: tests\e2e\07-notebook-ai.spec.mjs:9:3
...
Call log:
  - waiting for locator('button[title*="AI"], button[aria-label*="AI"], .editor-ai-toggle').first()
    ...
    - generic [ref=e87]:
      ...
      - generic [ref=e224]:
        ...
        - generic [ref=e239]:
          ...
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 1m ago Open" [ref=e245] [cursor=pointer]:
            - generic:
              - img [ref=e247]
              - generic:
            ...
            - button "Open" [active] [ref=e255]:
              - text: Open
              - img [ref=e256]
          - button "Playwright Test Notebook Ready to be sorted into a category Uncategorized 0 words 3m ago Open" [ref=e258] [cursor=pointer]:
            - generic:
              - img [ref=e260]
              - generic:
                - generic: Playwright Test Notebook
