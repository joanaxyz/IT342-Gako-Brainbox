...
public class FlashcardService {
    ...
    public FlashcardResponse getFlashcardResponse(String uuid) {
        return mapToResponse(getFlashcardByUuid(uuid));
    }
    ...
    @Transactional
    public void deleteFlashcard(String uuid) {
    ...
    @Transactional
    public void clearNotebookReference(Long notebookId) {
