package edu.cit.gako.brainbox.modules.playlist.service;
...
import edu.cit.gako.brainbox.modules.playlist.dto.request.PlaylistRequest;
...
public class PlaylistService {
    ...
    public PlaylistResponse getPlaylistResponseByUuid(String uuid) {
        return mapToResponse(getPlaylistByUuid(uuid));
    }
    ...
    public PlaylistResponse reorderQueue(String uuid, Long userId, PlaylistReorderRequest request) {
        ...
        List<Notebook> reordered = request.getNotebookUuids().stream()
                ...
                .peek(notebook -> notebook.assertOwnedBy(userId))
                .toList();
    ...
    @Transactional
    public void removeNotebookReferences(Long notebookId) {
    ...
    public Playlist getPlaylistByUuidAndUserId(String uuid, Long userId) {
        Playlist playlist = getPlaylistByUuid(uuid);
