...
import edu.cit.gako.brainbox.modules.notebook.dto.request.NotebookContentRequest;
import edu.cit.gako.brainbox.modules.notebook.dto.request.NotebookMutationRequest;
...
public class NotebookController {
    ...
    @RequireAuth
    @PatchMapping({"/update-review/{uuid}", "/{uuid}/review"})
