...
import edu.cit.gako.brainbox.modules.user.repository.UserRepository;
...
public class UserService {
    ...
    public void setSelectedAiConfig(User user, AiConfig aiConfig) {
        user.setSelectedAiConfig(aiConfig);
        userRepository.save(user);
    }

    public void clearSelectedAiConfig(User user) {
