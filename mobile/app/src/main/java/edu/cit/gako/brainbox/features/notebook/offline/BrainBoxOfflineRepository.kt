...
import edu.cit.gako.brainbox.platform.local.model.OfflinePackState
...
import edu.cit.gako.brainbox.platform.local.toModel
...
import edu.cit.gako.brainbox.features.notebook.data.dto.OfflineNotebookBundleItem
...
class BrainBoxOfflineRepository(
    ...
    suspend fun queueNotebookMutation(
        notebookUuid: String,
        operation: edu.cit.gako.brainbox.platform.local.model.PendingMutationOperation,
        payloadJson: String,
