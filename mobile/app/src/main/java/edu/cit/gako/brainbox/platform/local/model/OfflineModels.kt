package edu.cit.gako.brainbox.platform.local.model
...
data class AppPlayerPreferences(
    ...
    val playbackQueueOwnerKey: String? = null,
    val playbackQueuePlaylistUuid: String? = null,
    val playbackQueuePlaylistTitle: String? = null,
    val playbackQueueCurrentIndex: Int = 0,
    val playbackQueueShuffle: Boolean = false,
