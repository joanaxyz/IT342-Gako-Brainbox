package edu.cit.gako.brainbox.platform.local

import edu.cit.gako.brainbox.platform.local.entity.ConflictDraftEntity
import edu.cit.gako.brainbox.platform.local.entity.NotebookEntity
import edu.cit.gako.brainbox.platform.local.entity.OfflinePackEntity
import edu.cit.gako.brainbox.platform.local.entity.PendingMutationEntity
...
import edu.cit.gako.brainbox.platform.local.model.OfflinePack
...
fun AppPlayerPreferences.copyFrom(
    ...
    playbackQueueOwnerKey: String? = this.playbackQueueOwnerKey,
    playbackQueuePlaylistUuid: String? = this.playbackQueuePlaylistUuid,
    playbackQueuePlaylistTitle: String? = this.playbackQueuePlaylistTitle,
    playbackQueueCurrentIndex: Int = this.playbackQueueCurrentIndex,
    playbackQueueShuffle: Boolean = this.playbackQueueShuffle,
    ...
    return AppPlayerPreferences(
        ...
        playbackQueueOwnerKey = playbackQueueOwnerKey,
        playbackQueuePlaylistUuid = playbackQueuePlaylistUuid,
        playbackQueuePlaylistTitle = playbackQueuePlaylistTitle,
        playbackQueueCurrentIndex = playbackQueueCurrentIndex,
        playbackQueueShuffle = playbackQueueShuffle,
